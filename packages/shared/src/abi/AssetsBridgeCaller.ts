...
export const AssetsBridgeCallerAbi = [
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    name: "MinBridgeOutAmountForBitcoinChainSet",
    type: "event",
  },
  {
    anonymous: false,
  ...
  {
    inputs: [],
    name: "getMinBridgeOutAmountForBitcoinChain",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "setMinBridgeOutAmountForBitcoinChain",
    outputs: [
      {
        internalType: "bool",
        name: "",
